...
public class SpeechClient implements AutoCloseable {
   ...
   * @throws com.google.api.gax.grpc.ApiException if the remote call fails
   */
  public final OperationFuture<AsyncRecognizeResponse, Operation> asyncRecognizeAsync(
      RecognitionConfig config, RecognitionAudio audio) {
   ...
   * </code></pre>
   */
  public final OperationCallable<AsyncRecognizeRequest, AsyncRecognizeResponse, Operation>
