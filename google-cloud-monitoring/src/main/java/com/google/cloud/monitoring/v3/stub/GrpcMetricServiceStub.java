...
public class GrpcMetricServiceStub extends MetricServiceStub {
  ...
  private static final UnaryCallableImpl<GetMetricDescriptorRequest, MetricDescriptor>
  ...
  private static final UnaryCallableImpl<CreateMetricDescriptorRequest, MetricDescriptor>
      directCreateMetricDescriptorCallable =
          GrpcCallableFactory.createDirectCallable(
              io.grpc.MethodDescriptor.create(
                  ...
                  io.grpc.protobuf.ProtoUtils.marshaller(MetricDescriptor.getDefaultInstance())));
  private static final UnaryCallableImpl<DeleteMetricDescriptorRequest, Empty>
  ...
  private static final UnaryCallableImpl<ListTimeSeriesRequest, ListTimeSeriesResponse>
  ...
  private static final UnaryCallableImpl<CreateTimeSeriesRequest, Empty>
