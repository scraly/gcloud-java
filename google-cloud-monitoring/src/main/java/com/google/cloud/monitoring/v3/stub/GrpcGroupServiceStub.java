...
public class GrpcGroupServiceStub extends GroupServiceStub {
  private static final UnaryCallableImpl<ListGroupsRequest, ListGroupsResponse>
  ...
  private static final UnaryCallableImpl<GetGroupRequest, Group> directGetGroupCallable =
      GrpcCallableFactory.createDirectCallable(
          io.grpc.MethodDescriptor.create(
              io.grpc.MethodDescriptor.MethodType.UNARY,
  ...
  private static final UnaryCallableImpl<CreateGroupRequest, Group> directCreateGroupCallable =
      GrpcCallableFactory.createDirectCallable(
          io.grpc.MethodDescriptor.create(
              io.grpc.MethodDescriptor.MethodType.UNARY,
              ...
              io.grpc.protobuf.ProtoUtils.marshaller(Group.getDefaultInstance())));
  private static final UnaryCallableImpl<UpdateGroupRequest, Group> directUpdateGroupCallable =
      GrpcCallableFactory.createDirectCallable(
          io.grpc.MethodDescriptor.create(
              io.grpc.MethodDescriptor.MethodType.UNARY,
              ...
              io.grpc.protobuf.ProtoUtils.marshaller(Group.getDefaultInstance())));
  private static final UnaryCallableImpl<DeleteGroupRequest, Empty> directDeleteGroupCallable =
      GrpcCallableFactory.createDirectCallable(
          io.grpc.MethodDescriptor.create(
              io.grpc.MethodDescriptor.MethodType.UNARY,
  ...
  private static final UnaryCallableImpl<ListGroupMembersRequest, ListGroupMembersResponse>
