  ...
  public static class Builder extends ClientSettings.Builder {
    ...
    static {
      ...
      definitions.put(
          ...
          ImmutableSet.copyOf(
              Lists.<FailureCode>newArrayList(
                  GrpcFailureCode.of(Status.Code.CANCELLED),
                  GrpcFailureCode.of(Status.Code.UNKNOWN),
                  GrpcFailureCode.of(Status.Code.DEADLINE_EXCEEDED),
                  GrpcFailureCode.of(Status.Code.RESOURCE_EXHAUSTED),
                  GrpcFailureCode.of(Status.Code.ABORTED),
                  GrpcFailureCode.of(Status.Code.INTERNAL),
                  GrpcFailureCode.of(Status.Code.UNAVAILABLE))));
