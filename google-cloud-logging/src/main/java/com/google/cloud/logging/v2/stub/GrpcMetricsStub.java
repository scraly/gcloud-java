...
@BetaApi
public class GrpcMetricsStub extends MetricsStub {
  ...
  public static final GrpcMetricsStub create(MetricsSettings settings) throws IOException {
    return new GrpcMetricsStub(settings);
  }

  /**
   * Constructs an instance of GrpcMetricsStub, using the given settings. This is protected so that
   * it easy to make a subclass, but otherwise, the static factory methods should be preferred.
   */
  protected GrpcMetricsStub(MetricsSettings settings) throws IOException {
